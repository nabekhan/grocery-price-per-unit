(() => {
  ...
  (function initializeApiCapture(global) {
    ...
    function productsObject(entries) {
      const products = /* @__PURE__ */ Object.create(null);
    ...
    function installCapture(target, options = {}) {
      ...
      function wrappedFetch(...args) {
        ...
        void Promise.resolve(responsePromise).then((response) => captureResponse(response, requestUrl, context, requestSequence)).catch((error) => report(target, "warn", "Walmart search request rejected before capture", {
          ...errorDetails(error),
          query: context.query,
          requestSequence
        }));
