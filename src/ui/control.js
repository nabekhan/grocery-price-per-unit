...
export function injectStyles() {
  ...
  if (!style) {
    ...
    .lups-trigger-row{position:relative!important;display:flex!important;align-items:center!important;justify-content:flex-end!important;gap:8px!important}
    .lups-trigger-row:has(>#lups-flip-direction:not([hidden]))::before{position:absolute!important;right:100%!important;bottom:0!important;width:58px!important;height:50px!important;content:""!important}
    ...
    #lups-flip-direction{position:absolute!important;z-index:2!important;right:calc(100% + 8px)!important;bottom:0!important;width:50px!important;min-width:50px!important;height:50px!important;min-height:50px!important;border:0!important;background:#fffffff5!important;color:#334155!important;box-shadow:0 5px 16px #0f172a1f,0 1px 3px #0f172a1a!important;font-size:21px!important;font-weight:650!important;opacity:0!important;visibility:hidden!important;pointer-events:none!important;transform:translateX(10px) scale(.92)!important;transition:opacity .12s ease,transform .12s ease,visibility .12s ease,box-shadow .16s ease,background .16s ease!important}
    #lups-control[data-lups-menu-open="false"] .lups-trigger-row:hover>#lups-flip-direction:not([hidden]),#lups-control[data-lups-menu-open="false"] .lups-trigger-row:focus-within>#lups-flip-direction:not([hidden]){opacity:1!important;visibility:visible!important;pointer-events:auto!important;transform:none!important}
    #lups-flip-direction:hover{background:#f8fafc!important;transform:translateY(-1px)!important}
    ...
    @media(forced-colors:active){
      ...
      #lups-menu-button,#lups-flip-direction,#lups-reload,#lups-status-row,.lups-option-copy,.lups-default-copy,.lups-option-icon{border-width:2px!important;border-style:solid!important;border-color:CanvasText!important;background:Canvas!important;color:CanvasText!important;box-shadow:none!important}
